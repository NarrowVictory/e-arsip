		...
		<div class="box box-primary box-solid">
			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" value="<?= $no_arsip ?>" id="no_arsip" readonly="" name="no_arsip" placeholder="Masukkan No. Arsip">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="nama_file" name="nama_file" placeholder="Masukkan Nama Arsip">
				</div>
				<div class="form-group">
